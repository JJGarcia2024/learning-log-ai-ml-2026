...
new_cell = {
    ...
    "id": "list_tables_exercise",
    "metadata": {},
    "outputs": [],
    "source": list_tables_code
}

# Insert after cell 2 (which is the stackoverflow dataset cell)
if len(nb['cells']) > 2:
...
print("Notebook joining_data_exercise.ipynb updated with list tables code.")
